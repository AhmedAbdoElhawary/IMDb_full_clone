...
class Top250FilmsCubit extends Cubit<ResultState<FilmSubDetails>> {
  final Top250FilmsRepo _top250filmsRepo;
  Top250FilmsCubit(this._top250filmsRepo) : super(const initial());
  static Top250FilmsCubit get(BuildContext context) => BlocProvider.of(context);
  void getTop250Movies() async {
    emit(const ResultState.loading());
    ApiResult<FilmSubDetails> result = await _top250filmsRepo.getTop250Movies();
  ...
  void getTop250TVs() async {
    emit(const ResultState.loading());
    ApiResult<FilmSubDetails> result = await _top250filmsRepo.getTop250TVs();
