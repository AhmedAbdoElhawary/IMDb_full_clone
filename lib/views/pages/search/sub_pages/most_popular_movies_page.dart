...
class MostPopularMoviesPage extends StatelessWidget {
  const MostPopularMoviesPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        toolbarHeight: 56.h,
        title: Text("Most Popular Movies", style: getMediumStyle(fontSize: 22)),
      ),
      body: Center(
        child: BlocBuilder<MostPopularFilmsCubit, ResultState<FilmSubDetails>>(
          bloc: MostPopularFilmsCubit.get(context)..getMostPopularMovies(),
